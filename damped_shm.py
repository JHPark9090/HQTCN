...
t = np.linspace(0,20,240) # array of 240 evenly spaced time points from t=0 to t=20


theta = odeint(system,theta_0,t,args = (b,g,l,m))	# main simulation step 
...
scaler = MinMaxScaler(feature_range=(-1, 1))   # normalize to the range [-1, 1]
...
def transform_data_single_predict(data, seq_length):	# convert the flat time series into input and output pairs
	x = []
	y = []
